...
class LocalEmbedder:
    ...
    def __init__(self, model_path: Optional[str] = None):
        ...
        :param model_path: Optional path to an ONNX model file (e.g., 'models/all-MiniLM-L6-v2.onnx').
    ...
    def get_text_representation(self, node: Node) -> str:
        ...
        :param node: LineagIQ Graph Node model instance.
        :return: Contextual string ready for vector embedding.
        """
    ...
    def _l2_normalize(self, vec: List[float]) -> List[float]:
        ...
        :param vec: Unnormalized float vector list.
        :return: Unit-length L2-normalized float vector list.
        """
    ...
    def _embed_with_onnx(self, text: str) -> Optional[List[float]]:
        ...
        :return: 384-dimensional float vector list if inference succeeds, or None if failed.
        """
        try:
            import numpy as np
    ...
    def _embed_with_token_hash(self, text: str) -> List[float]:
        ...
        This guarantees that shared words (e.g. `raw_customers`) produce low cosine distance (~0.3-0.5)
        while unrelated words produce high distance (~1.0) without requiring heavy ML model binaries.

        :param text: Input string to embed.
        :return: 384-dimensional L2-normalized float vector list.
        """
    ...
    def embed_text(self, text: str) -> List[float]:
        ...
        :return: L2-normalized 384-dimensional float vector list.
        """
    ...
    def embed_payload(self, payload: GraphPayload) -> GraphPayload:
        ...
        :param payload: GraphPayload object containing nodes and edges.
        :return: Updated GraphPayload with vector embeddings attached to all nodes.
        """
